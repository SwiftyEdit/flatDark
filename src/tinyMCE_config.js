$(function () {
    $('textarea.mceEditor, textarea.mceEditor_small').tinymce({
        ...
        content_css: "/themes/flatDark/dist/editor.css",
        ...
        image_list: "/themes/flatDark/php/tinymce-images.php",
        image_advtab: true,
        image_title: true,

        link_list: "/themes/flatDark/php/tinymce-links.php",
        convert_urls: false,
        ...
        style_formats: [
            ...
            },
            {
                title: 'Badge/Alerts', items: [
                    {title: 'Badge', inline: 'span', classes: 'badge text-bg-secondary'},
                    {title: 'Badge Success', inline: 'span', classes: 'badge text-bg-success'},
                    {title: 'Badge Warning', inline: 'span', classes: 'badge text-bg-warning'},
                    {title: 'Badge Danger', inline: 'span', classes: 'badge text-bg-danger'},
