...
{* Instant-search modal, opened from the searchbox button above - same
   contract as the default theme's navigation.tpl (see search.php): a plain
   ...
   the top (plain modal-dialog, not modal-dialog-centered) since the result
   list grows as you type - centering it would waste the space above once
   it's tall. *}
